...
export function FourthPic(props) {
  const meshRef1 = useRef()
  
  // CURVED TV DISPLAY - Creates a gentle curve like Samsung curved TVs
  const texture2 = useTexture('/webp/programs/Group 109.webp')
  ...
  return (
    <group {...props} dispose={null} position={[-3.7, 1.04, -63.5]} rotation={[0, 0, 0]} scale={1.01} >
