...
export function ThirdPic(props) {
  const meshRef1 = useRef()
  
  // CURVED TV DISPLAY - Creates a gentle curve like Samsung curved TVs
  const texture2 = useTexture('/webp/programs/Group 108.webp')
  ...
  return (
    <group {...props} dispose={null} position={[-4.0, 1.04, -62.5]} rotation={[0, 0, 0]} scale={1.01} >
