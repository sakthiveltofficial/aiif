    ...
    return (
        <>
            <div ref={containerRef} className='text-white rounded-3xl border-8 md:border-[15px] border-gray-100 relative'>
                ...
                <div className='flex flex-col gap-3 md:gap-5 rounded-xl px-6 md:px-[3.5rem] py-8 md:py-[4rem] w-full md:w-[100%] bg-gradient-to-r from-[#4E73FF] from-0% via-[#4E73FF] via-100% to-transparent to-100% relative z-10'>
            ...
            <div ref={containerRef2} className='text-white mt-8 md:mt-[7rem] rounded-3xl border-8 md:border-[15px] border-gray-100 relative'>
                ...
                <div className='flex flex-col items-end gap-3 md:gap-5 rounded-xl px-6 md:px-[3.5rem] py-8 md:py-[4rem] justify-self-end w-full md:w-[100%] bg-gradient-to-l from-[#00CA40] from-0% via-[#00CA40] via-100% to-transparent to-100% relative z-10'>
